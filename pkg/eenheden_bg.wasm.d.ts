...
export const get_time_formats: () => [number, number];
export const get_distance_formats: () => [number, number];
export const convert_seconds: (a: number, b: number, c: number) => [number, number];
